        ...
        <div class="mv-breadcrumb-style-1">
          <div class="container">
            <ul class="breadcrumb-1-list">
              ...
              <li><a>Contactanos / Sucursal Ortega</a></li>
            </ul>
          </div>
        </div>
</section>
<section class="mv-main-body contact-us-main mv-bg-gray mv-wrap">
	  ...
	  <div class="contact-us-map">
          <div class="map-embed">
		          <center> <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7651.170327545766!2d-68.14734850962965!3d-16.496530068885292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x915f20758a57b7bf%3A0x3fbbeb40dd7aa247!2sLa%20Salvadora%20Hnos%20SRL%20Suc%203!5e0!3m2!1ses-419!2sbo!4v1581968511232!5m2!1ses-419!2sbo" width="1200" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe></center>
          </div>
  	 </div>
</section>
<section class="mv-main-body contact-us-main mv-bg-gray mv-wrap>
                      ...
                      <div class="mv-icon-left-style-7">
                        <div class="i-l-inner">
                          <div class="i-l-text"><span class="i-l-icon icon-map-marker fa  fa-map-marker mv-f-54 mv-color-primary"></span>
                            ...
                            <div class="text-sub">Pasaje Ortega Nro 670 Zona 14 de Septiembre</div>
                         </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="mv-icon-left-style-7">
                        <div class="i-l-inner">
                          <div class="i-l-text"><span class="i-l-icon icon-mobile fa fa-mobile mv-f-60 mv-color-primary"></span>
                            ...
                            <div class="text-sub"> 
                             Teléfono:<a href="index.php">2-452184</a> <br>
                             Celular:<a href="index.php">76797120</a><br>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="mv-icon-left-style-7">
                        <div class="i-l-inner">
                          <div class="i-l-text"><span class="i-l-icon icon-envelope fa fa-envelope-o mv-f-48 mv-color-primary"></span>
                            ...
                            <div class="text-sub">
                            Correo: <a href="index.php">sucortega@lasalvadorahnos.com</a><br>
              ...
              <div class="block-32-form mv-box-shadow-gray-1">
                ...
                <div class="block-32-form-main">
                  ...
                  <form action="<?=base_url()?>Contactanos/email"  method="post"  class="form-contact mv-form-horizontal" >
                    <input type="hidden" name="sucursal" value="ortega">
                    <div class="row">
                      <div class="col-sm-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="mv-form-group">
                          ...
                          <div class="col-md-10 mv-field">
                            <input placeholder=" ingrese su telefono" type="text" name="telefono" class="mv-inputbox mv-inputbox-style-1"/>
                          </div>
                        </div>
                      </div>
                    </div>
