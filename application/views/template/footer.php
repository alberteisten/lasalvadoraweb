    <footer class="footer mv-footer-style-3 mv-wrap">
        <div style="background-image: url(images/background/demo_bg_7.jpg)" class="footer-bg">
                ...
                <div class="row">
                  <div class="col-sm-4 col-md-3 col-payment">
                    <div class="footer-payment">
                      <ul class="mv-ul list">
                        <li class="item"><a href="#"><img src="<?=base_url();?>assets/images/icon/icon_paypal.png" alt="icon"/></a></li>
                        <li class="item"><a href="#"><img src="<?=base_url();?>assets/images/icon/icon_master_card.png" alt="icon"/></a></li>
                        <li class="item"><a href="#"><img src="<?=base_url();?>assets/images/icon/icon_american_express.png" alt="icon"/></a></li>
                        <li class="item"><a href="#"><img src="<?=base_url();?>assets/images/icon/icon_visa.png" alt="icon"/></a></li>
                      </ul>
                    </div>
                    <!-- .footer-payment-->
                  </div>
                    ...
                    <div class="block-24-list">
                        ...
                        <div class="item-inner">
                          <div class="mv-dp-table">
                            <div class="mv-dp-table-cell block-24-thumb">
                              <div class="thumb-inner mv-lightbox-style-1"><a href="product-detail.html" title="Open Face Helmets"><img src="<?=base_url();?>assets/images/demo/demo_2.png" alt="demo"/></a><a href="images/demo/demo_2.png" title="Open Face Helmets" data-lightbox-href="product-detail.html" class="mv-btn mv-btn-style-20 mv-lightbox-item"><i class="icon fa fa-search"></i></a></div>
                            </div>
                      ...
                      <article class="item post">
                        <div class="item-inner">
                          <div class="mv-dp-table">
                            <div class="mv-dp-table-cell block-24-thumb">
                              <div class="thumb-inner mv-lightbox-style-1"><a href="product-detail.html" title="Richa Drift Water"><img src="<?=base_url();?>assets/images/demo/demo_7.png" alt="demo"/></a><a href="images/demo/demo_7.png" title="Richa Drift Water" data-lightbox-href="product-detail.html" class="mv-btn mv-btn-style-20 mv-lightbox-item"><i class="icon fa fa-search"></i></a></div>
                            </div>
                            <div class="mv-dp-table-cell block-24-main">
    ...
    <!-- Vendor jQuery-->
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery/jquery-2.1.4.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery/jQuery.paginate.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/smoothscroll/SmoothScroll.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/superfish-menu/js/superfish.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery-ui/jquery-ui.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery-ui/external/touch-punch/jquery.ui.touch-punch.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery-ui/external/jquery.mousewheel.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/parallax/parallax.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery-countto/jquery.countTo.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery-appear/jquery.appear.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/as-pie-progress/jquery-asPieProgress.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/caroufredsel/helper-plugins/jquery.touchSwipe.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/caroufredsel/jquery.carouFredSel-6.2.1-packed.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/isotope/isotope.pkgd.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/isotope/fit-columns.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/slick-sider/slick.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/lwt-countdown/jquery.lwtCountdown-1.0.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/swiper-sider/dist/js/swiper.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jplayer/dist/jplayer/jquery.jplayer.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/libs/jquery-cookie/jquery.cookie.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>assets/js/paginacion.js"></script>

    <!-- Theme Script-->
    <!--<script type="text/javascript" src="<?=base_url();?>assets/js/style.selector.js"></script>-->
